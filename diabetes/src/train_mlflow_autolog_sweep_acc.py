...
# set autolog, and see if the artifacts for the trials are logged
mlflow.autolog()
...
def parse_args():
    ...
    parser.add_argument("--registered_model_name", 
                        type=str, default="diabetes_classification_model", help="model name",)

    # parse args and log them:
